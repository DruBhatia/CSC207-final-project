...
public class MemoryView extends View {
  ...
  MemoryView(AppCompatActivity context) {
    ...
    cardArray.add(new PlayingCard(11, (ImageView) context.findViewById(R.id.iv_11)));
    int[] arr1 = new int[] {101, R.drawable.fv_image101};
    imageArray.add(arr1);
    cardArray.add(new PlayingCard(12, (ImageView) context.findViewById(R.id.iv_12)));
    int[] arr2 = new int[] {102, R.drawable.fv_image102};
    imageArray.add(arr2);
    cardArray.add(new PlayingCard(13, (ImageView) context.findViewById(R.id.iv_13)));
    int[] arr3 = new int[] {103, R.drawable.fv_image103};
    imageArray.add(arr3);
    cardArray.add(new PlayingCard(14, (ImageView) context.findViewById(R.id.iv_14)));
    int[] arr4 = new int[] {104, R.drawable.fv_image104};
    imageArray.add(arr4);
    cardArray.add(new PlayingCard(15, (ImageView) context.findViewById(R.id.iv_21)));
    int[] arr5 = new int[] {105, R.drawable.fv_image105};
    imageArray.add(arr5);
    cardArray.add(new PlayingCard(16, (ImageView) context.findViewById(R.id.iv_22)));
    int[] arr6 = new int[] {106, R.drawable.fv_image106};
    imageArray.add(arr6);
    cardArray.add(new PlayingCard(17, (ImageView) context.findViewById(R.id.iv_23)));
    int[] arr7 = new int[] {107, R.drawable.fv_image107};
    imageArray.add(arr7);
    cardArray.add(new PlayingCard(18, (ImageView) context.findViewById(R.id.iv_24)));
    int[] arr8 = new int[] {108, R.drawable.fv_image108};
    imageArray.add(arr8);
    cardArray.add(new PlayingCard(21, (ImageView) context.findViewById(R.id.iv_31)));
    int[] arr9 = new int[] {201, R.drawable.fv_image201};
    imageArray.add(arr9);
    cardArray.add(new PlayingCard(22, (ImageView) context.findViewById(R.id.iv_32)));
    int[] arr10 = new int[] {202, R.drawable.fv_image202};
    imageArray.add(arr10);
    cardArray.add(new PlayingCard(23, (ImageView) context.findViewById(R.id.iv_33)));
    int[] arr11 = new int[] {203, R.drawable.fv_image203};
    imageArray.add(arr11);
    cardArray.add(new PlayingCard(24, (ImageView) context.findViewById(R.id.iv_34)));
    ...
    cardArray.add(new PlayingCard(27, (ImageView) context.findViewById(R.id.iv_43)));
    int[] arr15 = new int[] {207, R.drawable.fv_image207};
    imageArray.add(arr15);
    cardArray.add(new PlayingCard(28, (ImageView) context.findViewById(R.id.iv_44)));
